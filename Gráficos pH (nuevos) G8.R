...
df_pldj2025 <- read_excel("Gráfico pH G8.xlsx", sheet = "PLDJ 2025")
...
## Graficamos puntos conectados en el tiempo de pH de PLDJ 2025 usando gpplot

# Filtramos los tratamientos específicos, con sus respectivos controles:

df_pldj2025_3.5ph <- df_pldj2025 %>%
  filter(Treatment %in% c("1", "4", "7", "Whey"))

df_pldj2025_4.8ph <- df_pldj2025 %>%
  filter(Treatment %in% c("2", "5", "8", "Whey"))

df_pldj2025_6ph <- df_pldj2025 %>%
  filter(Treatment %in% c("3", "6", "9", "Whey"))

# Primero, el pH de T1, T4 y T7 de PLDJ 2025:
ggplot(df_pldj2025_3.5ph, aes(x = `Time (days)`, y = pH)) +
  ...
  scale_y_continuous(breaks = seq(0, 14, by = 0.2)) +
...
# Segundo, el pH de T2, T5 y T8 de PLDJ 2025:
ggplot(df_pldj2025_4.8ph, aes(x = `Time (days)`, y = pH)) +
  geom_line(aes(group = Treatment, color = Treatment)) +
  geom_point(aes(shape = Treatment, fill = Treatment),
             color = "black",
             size = 4,
...
# Tercero, el pH de T3, T6 y T9 de PLDJ 2025:
ggplot(df_pldj2025_6ph, aes(x = `Time (days)`, y = pH)) +
  geom_line(aes(group = Treatment, color = Treatment)) +
  geom_point(aes(shape = Treatment, fill = Treatment),
             color = "black",
             size = 4,
...
df_pldj2025lmm <- read_excel("Gráfico pH G8.xlsx", sheet = "PLDJ 2025 LMM")
...
df_pldj20261 <- read_excel("Gráfico pH G8.xlsx", sheet = "PLDJ 2026-1")
...
## Creamos un dataframe con errores estándares de PLDJ 2026-1
df_pldj20261_bar <- df_pldj20261 %>%
...
## Graficamos puntos conectados en el tiempo de pH de PLDJ 2026-1 usando gpplot

# Filtramos los tratamientos específicos, con sus respectivos controles:

df_pldj20261_3.5ph <- df_pldj20261_bar %>%
  filter(Treatment %in% c("1", "4", "7", "Whey"))

df_pldj20261_4.8ph <- df_pldj20261_bar %>%
  filter(Treatment %in% c("2", "5", "8", "Whey"))

df_pldj20261_6ph <- df_pldj20261_bar %>%
  filter(Treatment %in% c("3", "6", "9", "Whey"))

# Primero, el pH de T1, T4 y T7 de PLDJ 2026-1:
ggplot(df_pldj20261_3.5ph, aes(x = `Time (days)`, y = pH)) +
  geom_line(aes(group = Treatment, color = Treatment)) +
  geom_point(aes(shape = Treatment, fill = Treatment),
             color = "black",
             size = 4,
             stroke = 0.8) +
  geom_errorbar(aes(ymin = pH - se, ymax = pH + se, color = Treatment), 
                width = 0.1,
                linewidth = 1) +
  scale_shape_manual(values = c(
    "1" = 21,  
...
# Segundo, el pH de T2, T5 y T8 de PLDJ 2026-1:
ggplot(df_pldj20261_4.8ph, aes(x = `Time (days)`, y = pH)) +
  geom_line(aes(group = Treatment, color = Treatment)) +
  geom_point(aes(shape = Treatment, fill = Treatment),
             color = "black",
             size = 4,
...
# Tercero, el pH de T3, T6 y T9 de PLDJ 2026-1:
ggplot(df_pldj20261_6ph, aes(x = `Time (days)`, y = pH)) +
  geom_line(aes(group = Treatment, color = Treatment)) +
  geom_point(aes(shape = Treatment, fill = Treatment),
             color = "black",
             size = 4,
...
## Cargamos un nuevo set de datos y transformamos las columnas para un LMM
df_pldj20261lmm <- read_excel("Gráfico pH G8.xlsx", sheet = "PLDJ 2026-1 LMM")
...
df_phad <- read_excel("Gráfico pH G8.xlsx", sheet = "PHAD")
...
## Graficamos puntos conectados en el tiempo de pH de PHAD usando gpplot

# Filtramos los tratamientos específicos, con sus respectivos controles:

df_phad_3.5ph <- df_phad %>%
  filter(Treatment %in% c("1", "4", "7", "Whey"))

df_phad_4.8ph <- df_phad %>%
  filter(Treatment %in% c("2", "5", "8", "Whey"))

df_phad_6ph <- df_phad %>%
  filter(Treatment %in% c("3", "6", "9", "Whey"))

# Primero, el pH de T1, T4 y T7 de PHAD:
ggplot(df_phad_3.5ph, aes(x = `Time (days)`, y = pH)) +
  geom_line(aes(group = Treatment, color = Treatment)) +
  geom_point(aes(shape = Treatment, fill = Treatment),
             color = "black",
             size = 4,
...
# Segundo, el pH de T2, T5 y T8 de PHAD:
ggplot(df_phad_4.8ph, aes(x = `Time (days)`, y = pH)) +
  geom_line(aes(group = Treatment, color = Treatment)) +
  geom_point(aes(shape = Treatment, fill = Treatment),
             color = "black",
             size = 4,
  ...
  scale_y_continuous(breaks = seq(0, 14, by = 0.1)) +
  labs(title = "Pholiota adiposa") +
  theme(plot.title = element_text(size = 16, face = "italic"),
        axis.title.x = element_text(size = 14, face = "bold"),
        axis.title.y = element_text(size = 14, face = "bold"),
...
# Tercero, el pH de T3, T6 y T9 de PHAD:
ggplot(df_phad_6ph, aes(x = `Time (days)`, y = pH)) +
  geom_line(aes(group = Treatment, color = Treatment)) +
  geom_point(aes(shape = Treatment, fill = Treatment),
             color = "black",
             size = 4,
...
## Cargamos un nuevo set de datos y transformamos las columnas para un LMM
df_phadlmm <- read_excel("Gráfico pH G8.xlsx", sheet = "PHAD LMM")
